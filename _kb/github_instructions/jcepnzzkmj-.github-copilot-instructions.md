# jcepnzzkmj - GitHub Copilot Instructions

**Project:** jcepnzzkmj
**Location:** /home/master/applications/jcepnzzkmj
...
This is the **CIS Staff Portal** for Ecigdis Ltd / The Vape Shed.

### Key Features:
- Staff portal and inventory management
...
### Critical Paths:
- `/public_html/_automation/` - Multi-bot automation system
- `/public_html/modules/` - Modular application structure
- `/public_html/assets/functions/` - Core system functions
...
- `public_html/modules/` - Modular architecture
