<?php
/**
 * File: public/api/DatabaseTool.php
 * Purpose: HTTP wrapper bridging MCP database tool calls into App\Tools\DatabaseTool
...
$toolName = isset($payload['tool']) && is_string($payload['tool']) ? $payload['tool'] : 'db.query';
...
try {
    $result = DatabaseTool::run($arguments, $context);
} catch (\Throwable $exception) {
    ApiBootstrap::error('Database tool execution failed', 500, 'tool_error', [
