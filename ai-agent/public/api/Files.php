<?php
/**
 * File: public/api/Files.php
 * Purpose: HTTP wrapper bridging MCP filesystem tool calls into App\Tools\FileTool
...
$toolName = isset($payload['tool']) && is_string($payload['tool']) ? $payload['tool'] : 'fs.list';
...
try {
    $result = FileTool::run($arguments, $context);
} catch (\Throwable $exception) {
    ApiBootstrap::error('File tool execution failed', 500, 'tool_error', [
