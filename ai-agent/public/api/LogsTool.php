<?php
/**
 * File: public/api/LogsTool.php
 * Purpose: HTTP wrapper bridging MCP logs.tail calls into App\Tools\LogsTool
...
$toolName = isset($payload['tool']) && is_string($payload['tool']) ? $payload['tool'] : 'logs.tail';
...
try {
    $result = LogsTool::run($arguments, $context);
} catch (\Throwable $exception) {
    ApiBootstrap::error('Logs tool execution failed', 500, 'tool_error', [
