        ...
        <section class="metrics-row">
            <article class="metric-card">
                ...
                <div class="metric-card__content">
                    <div class="metric-card__value"><?php echo number_format((int)$stats['total_files']); ?></div>
                    <div class="metric-card__label">Total Files</div>
            ...
            <article class="metric-card">
                ...
                <div class="metric-card__content">
                    <div class="metric-card__value"><?php echo number_format((int)$stats['total_scans']); ?></div>
                    <div class="metric-card__label">Total Scans</div>
                    <div class="metric-card__change metric-card__change--neutral">
                        Historical scans
                    </div>
                </div>
            ...
            <article class="metric-card">
                ...
                <div class="metric-card__content">
                    <div class="metric-card__value"><?php echo number_format((int)$stats['total_violations']); ?></div>
                    <div class="metric-card__label">Violations</div>
                    <div class="metric-card__change <?php echo (int)$stats['total_violations'] > 0 ? 'metric-card__change--negative' : 'metric-card__change--positive'; ?>">
                        <?php echo (int)$stats['total_violations'] > 0 ? 'Requires attention' : 'All clear'; ?>
                    </div>
                </div>
            </article>
            ...
            <article class="metric-card">
                ...
                <div class="metric-card__content">
                    <div class="metric-card__value"><?php echo $projectSettings['scan_schedule'] === '0 2 * * *' ? 'Daily' : 'Custom'; ?></div>
                    <div class="metric-card__label">Scan Schedule</div>
                    <div class="metric-card__change metric-card__change--neutral">
                        Automated scans
                    </div>
                </div>
        ...
        <section class="content-section">
            <div class="tabs">
                <div class="tabs__header">
                    <button type="button" class="tabs__tab tabs__tab--active" data-tab="general">
                        <i class="fas fa-cog"></i> General
                    </button>
                    <button type="button" class="tabs__tab" data-tab="scan">
                        <i class="fas fa-search"></i> Scan Config
                    </button>
                    <button type="button" class="tabs__tab" data-tab="notifications">
                        <i class="fas fa-bell"></i> Notifications
                    </button>
                    <button type="button" class="tabs__tab" data-tab="integrations">
                        <i class="fas fa-plug"></i> Integrations
                    </button>
                    <button type="button" class="tabs__tab" data-tab="advanced">
                        <i class="fas fa-sliders-h"></i> Advanced
                    </button>
                </div>

                <!-- General Settings Tab -->
                <div class="tabs__content tabs__content--active" data-tab-content="general">
                    <form method="POST" class="settings-form">
                        <div class="settings-section">
                            ...
                            <div class="form__group">
                                ...
                                <input type="text" id="project-name" class="form-control" value="<?php echo htmlspecialchars($projectData['project_name']); ?>" placeholder="My Project">
                            </div>

                            <div class="form__group">
                                <label for="project-description" class="form__label">Project Description</label>
                                <textarea id="project-description" class="form-control" rows="3" placeholder="Describe your project...">Project description goes here</textarea>
                            </div>

                            <div class="form__row">
                                <div class="form__group">
                                    <label for="project-status" class="form__label">Project Status</label>
