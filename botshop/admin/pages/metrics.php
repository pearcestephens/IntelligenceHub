<?php
/**
 * Dashboard Metrics Page - PHASE 2 UPDATED
                ...
                <div class="card-body text-center">
                    <div style="position: relative; display: inline-block; width: 100px; height: 100px;">
                        ...
                        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 24px; font-weight: bold; color: #4e73df;">
                            <?php echo round((float)($metrics['health_score'] ?? 0)); ?>%
                        </div>
                    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h2><?php echo round((float)($metrics['technical_debt'] ?? 0)); ?>%</h2>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h2><?php echo round((float)($metrics['complexity_score'] ?? 0), 1); ?></h2>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h2><?php echo round((float)($metrics['test_coverage'] ?? 0)); ?>%</h2>
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h3><?php echo number_format((int)($metrics['lines_of_code'] ?? 0)); ?></h3>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h3><?php echo number_format((int)($fileMetrics['total_files'] ?? 0)); ?></h3>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <h3><?php echo round((float)($fileMetrics['avg_dependencies'] ?? 0), 1); ?></h3>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-sm mb-0">
                        <tr>
                            <td>PHP Files</td>
                            <td class="text-end"><strong><?php echo number_format((int)($fileMetrics['php_files'] ?? 0)); ?></strong></td>
                        </tr>
                        <tr>
                            <td>JavaScript Files</td>
                            <td class="text-end"><strong><?php echo number_format((int)($fileMetrics['js_files'] ?? 0)); ?></strong></td>
                        </tr>
                        <tr>
                            <td>CSS Files</td>
                            <td class="text-end"><strong><?php echo number_format((int)($fileMetrics['css_files'] ?? 0)); ?></strong></td>
                        </tr>
                    </table>
                </div>
            </div>
