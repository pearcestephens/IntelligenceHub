<?php
/**
 * Dashboard Files Page - PHASE 2 UPDATED
...
$query = "SELECT * FROM intelligence_files WHERE project_id = ?";
$params = [$projectId];
...
// Get total count
// PHASE 2: Add project_id filter for multi-project support
$countQuery = "SELECT COUNT(*) FROM intelligence_files WHERE project_id = ?";
