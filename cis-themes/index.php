...
// Get requested theme or default
$requestedTheme = $_GET['theme'] ?? $_SESSION['cis_active_theme'] ?? 'professional-dark';

// Check if theme exists
$availableThemes = $themeEngine->getAvailableThemes();

if (!in_array($requestedTheme, array_column($availableThemes, 'slug'))) {
    ...
    <body>
        <div class="container">
            ...
            <div class="theme-grid">
                ...
                <a href="?theme=<?php echo $theme['slug']; ?>" class="theme-card">
                    <div class="theme-name"><?php echo $theme['name']; ?></div>
                    <div class="theme-version">v<?php echo $theme['version']; ?> by <?php echo $theme['author']; ?></div>
            ...
            <div class="stats">
                ...
                <div class="stats-grid">
                    <div>
                        <div class="stat-value"><?php echo count($themes); ?></div>
